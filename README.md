...
только этот стек который ниже опиши как то что ты делал допустим
   Язык и сборка:
   первым делом идёт ключевое слово а потом всё остальное
   - Java -------> я знаю то и то
...
смотри я работал уже с многими технологиями я java spring поэтому я не новичок твоя задача напомнить мне с 0 обо всём что надо знать (шыкарная база) и просто важные штуки термины и т.д. что встретится на роботе. чисто проавдиво без воды, но не переборщи с абстракцией можно с примерами супер простыми
